 ...
 * Branches Model
 *
 * @property \App\Model\Table\RepositoriesTable&\Cake\ORM\Association\BelongsTo $Repositories
 *
...
class BranchesTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn('repository_id', 'Repositories'), ['errorField' => 'repository_id']);
